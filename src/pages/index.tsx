...
export const getServerSideProps: GetServerSideProps<HomeProps> = async (): Promise<GetServerSidePropsResult<HomeProps>> => {
    const numberToSend = 190; // 76; // Replace with the desired number
